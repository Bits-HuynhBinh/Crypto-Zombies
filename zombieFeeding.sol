...
//---------------------------------------------------------------------------------------------------------------------
///37. Create a modifier function "ownedOf" to take 1 argument and require that msg.sender is equal to _zombieToOwner[zombieId].
// step 37.1 is a few lines below.
//---------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------
///37.1 Change function definition so that it now uses the ownerOf modifier and remove the require statement at the 
/// top of the function. Go to ZombieHelper for step 38. 
//---------------------------------------------------------------------------------------------------------------------


    function feedAndMultiply(uint _zombieId, uint _targetDna,string specices) public ownerOf(_zombieId) {
